...
public:
    ...
    //This declares less than operator overload as a member of the function of the service account class
    bool operator<(const ServiceAccount& other) const; // Correctly declared here
